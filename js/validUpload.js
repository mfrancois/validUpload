        ...
        jQuery.extend(jQuery.validUpload, {
            ...
            prototype: {
                    ...
                    if (!this.settings.dataUploader.multi_selection) {
                        ...
                        for (var i in tabFile) {
                            if (typeof(tabFile[i]) != 'undefined' && tabFile[i] != null && tabFile[i] != '') {
                                this.addOneItem({
                                    'id': tabFile[i].substring(0, tabFile[i].indexOf('.')),
                                    'target_name': tabFile[i],
                                    'name': tabFile[i]
                                });
                ...
                addOneItem: function (file) {
                    ...
                    this.settings.onAfterAddOneItem(file);
                    this.initEventItem();
                ...
                initEvent: function () {
                    ...
                    jQuery(this.settings.selectorUploadDelete, this.element).off('click').on('click', jQuery.proxy(this.removeElement, this));
