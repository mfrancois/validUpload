        ...
        attach:function (userOptions) {
            ...
            if (!options.binded) {
                if (options.bindMethod == "bind") {
                    form.find("[class*=validate]:not([type=checkbox])").not("[type=radio]").not(".datepicker").not(".monthpicker").bind(options.validationEventTrigger, methods._onFieldEvent);
                    form.find("[class*=validate][type=checkbox],[class*=validate][type=radio]").bind("click", methods._onFieldEvent);
                    form.find("[class*=validate][class*=datepicker][class*=monthpicker]").bind(options.validationEventTrigger, {"delay":300}, methods._onFieldEvent);
                    ...
                    form.find("[class*=validate][class*=datepicker][class*=monthpicker]").live(options.validationEventTrigger, {"delay":300}, methods._onFieldEvent);
...
// read the optional msg from the server
                            ...
                            if (!status) {
                                ...
                                if (msg) {
                                    ...
                                    msg = rule.alertText;
                                methods._showPrompt(errorField, msg, '', true, options,false);
                            } else {
